...
Probleem on lihtkirjas andmete leidmine. Hea tulemus oleks treenitud LLM, mis saaks lihtkirjas aru, mis otsija soovib ning annab soovitusi, koostab informatsiooni põhjal vastuse.
...
Probleem on tudengitel, kes soovivad õppeainetele registreerida. Vajab lahendamist, sest õppeainetele registreerimine ei ole piisavalt lihtne. Oodatud kasu on õppeainetele registreerumise kasv, õpilaste hariduse mitmekesistamine. Hetkel peavad õpilased sobivate aineteni jõudmiseks läbima valikuid, mis ei ole piisavalt spetsiifilised nende ainekavade ja vaba aja jaoks.
> ...

### 🔴 1.2 Edukuse mõõdikud
Kuidas mõõdame rakenduse edukust? Mida peab rakendus teha suutma?
Kuna projekti raames ei ole lubatud algandmete kasutamine, siis rakenduse edukus on mõõdetud chatbot'i efektiivsuses. Chatbot peab suutma küsida õigeid küsimusi ja pakkuda õigeid vastuseid.
> ...
